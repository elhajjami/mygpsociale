...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('admin.roles.store') }}" class="bg-white rounded-lg shadow p-6 space-y-6">
        @csrf
        ...
        <div class="flex justify-end gap-4 pt-4 border-t">
            <a href="{{ route('admin.roles.index') }}" class="px-4 py-2 text-gray-700 hover:text-gray-900">
                Annuler
            </a>
