                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <div class="flex space-x-2">
                                <a href="{{ route('admin.partenaires.show', $partenaire->id) }}" class="text-blue-600 hover:text-blue-800">Voir</a>
                                <a href="{{ route('admin.partenaires.edit', $partenaire->id) }}" class="text-yellow-600 hover:text-yellow-800">Modifier</a>
                            </div>
                        </td>
                    </tr>
                    @empty
